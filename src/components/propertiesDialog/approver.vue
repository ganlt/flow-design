          ...
          <div class="x-layout-table-row">
            <div class="x-layout-table-item base_select member_select" widgetname="memberSelect" style="width: 570px; height: 450px;">
              ...
              <div class="select-menu">
                ...
                <div class="select-btn" :class="departmentSelected" role="department" @click="selectDepartment">组织架构</div>
                <div class="select-btn" :class="roleSelected" role="role" @click="selectRole">角色</div>
                <div class="select-btn" :class="memberSelected" role="member" @click="selectMember">成员</div>
                <div class="select-btn" :class="dynamicSelected" role="dynamic" @click="selectDynamic">动态负责人</div>
              </div>
...
export default {
  ...
  methods: {
    ...
    handleSaveAndCloseDialog () {
      console.log('保存数据并退出')
      this.$emit('closeApproverDialog', this.list)
    }
  },
  watch: {
    showDepartment (val) {
      if (!val) {
        ...
        this.departmentSelected = 'selected'
      }
    },
    showRole (val) {
      if (!val) {
